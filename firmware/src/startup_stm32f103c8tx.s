...
// fill stack segment so we can see how much of the stack is really used .. 1o11
  ldr   r0,=_estack              // r0 = end of stack
  ldr   r1,=_Min_Stack_Size      // r1 = size of stack
  cbz   r1,fill_stack2           // no stack
  sub   r1,r0,r1                 // r1 = r0 - r1        r1 = start of stack
  movs  r2,#0xCCCCCCCC           // r2 = fill value
fill_stack1:
  str   r2,[r1],#4               // *r1++ = r2
  cmp   r1,r0
  bcc   fill_stack1
...
// fill heap segment so we can see how much of the heap is really used .. 1o11
  ldr   r0,=_estack              // r0 = end of stack
  ldr   r1,=_Min_Stack_Size      // r1 = size of stack
